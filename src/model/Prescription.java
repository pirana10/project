...
public class Prescription {
    ...
    public Prescription(String prescriptionId, String patientId, String clinicianId, String appointmentId, String prescriptionDate,
                        String medicationName, String dosage, String frequency, String durationDays, String quantity,
                        String instructions, String pharmacyName, String status, String issueDate, String collectionDate) {
    ...
    public String toCSV() {
        return prescriptionId + "," + patientId + "," + clinicianId + "," + appointmentId + "," + prescriptionDate + "," +
